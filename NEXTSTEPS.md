...
# Next Steps for ndx-mp4 Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-mp4 directory: `cd ndx-mp4`
...
`spec/ndx-mp4.namespace.yaml` and
`spec/ndx-mp4.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-mp4
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/rly/ndx-mp4/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-mp4/0.1.0
...
`staged-extensions/ndx-mp4`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-mp4
    ```

13. Edit `staged-extensions/ndx-mp4/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-mp4
      version: 0.1.0
      src: https://github.com/rly/ndx-mp4
      pip: https://pypi.org/project/ndx-mp4/
      license: BSD-3
      maintainers: 
        - rly
      ```

14. Edit `staged-extensions/ndx-mp4/README.md`
to add information about your extension. You may copy it from
`ndx-mp4/README.md`.

  ```bash
  cp ndx-mp4/README.md staged-extensions/ndx-mp4/README.md
  ```
...
git add ndx-mp4
git commit -m "Add new catalog entry for ndx-mp4" .
git push
```
...
ndx-mp4-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-mp4 GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-mp4-record repository on GitHub.
